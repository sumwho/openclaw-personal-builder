...
- English Kokoro currently falls back to Piper because Kokoro's English path still has an upstream spaCy runtime dependency that is not fully mirrored locally.
...
- English Kokoro is not fully offline yet.
